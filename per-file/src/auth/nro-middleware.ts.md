...
| Branches | 77.48% (86/111) | `████████░░` |
| Functions | 95.45% (21/22) | `██████████` |
| Lines | 91.67% (121/132) | `█████████░` |

**Uncovered lines:** 83-84, 207, 298-299, 367-368, 370, 385, 438, 444-445

**Partial branches:** L41 (cond-expr), L62 (if), L68 (cond-expr), L78 (if), L95 (if), L97 (binary-expr), L121 (binary-expr), L195 (if), L200 (if), L203 (if), L275 (binary-expr), L297 (if), L343 (if), L344 (if), L351 (cond-expr), L366 (binary-expr), L378 (binary-expr), L379 (if), L381 (if), L396 (binary-expr), L405 (cond-expr), L443 (if)
